...
// ✅ API BASE URL for production on Vercel
// Use Render backend when env variable is not set
const API_BASE_URL =
  process.env.REACT_APP_API_URL || "https://nexuscrm-server.onrender.com/api";
...
export const campaignsAPI = {
  ...
  exportCampaigns: (params) =>
    api.get("/campaigns/export", { params, responseType: "blob" }),
};
...
export const organizationsAPI = {
  ...
  exportOrganizations: (params) =>
    api.get("/organizations/export", { params, responseType: "blob" }),
};
...
export const donationsAPI = {
  ...
  updateSubscriptionStatus: (id, data) =>
    api.put(`/donations/${id}/subscription`, data),
  exportDonations: (params) =>
    api.get("/donations/export", { params, responseType: "blob" }),
};
...
export const agenciesAPI = {
  ...
  exportAgencies: (params) =>
    api.get("/agencies/export", { params, responseType: "blob" }),
};
...
export const receiptsAPI = {
  ...
  exportReceipts: (params) =>
    api.get("/receipts/export", { params, responseType: "blob" }),
};
